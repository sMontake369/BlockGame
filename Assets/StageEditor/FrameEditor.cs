...
public class FrameEditor : MonoBehaviour
{
    ...
    RootBlock frameRBlock;
    RootBlock backGroundRBlock;
    RootBlock selectRBlock;
    ...
    void Start()
    {
        ...
        blockTypeDropdown.options.Add(new TMP_Dropdown.OptionData(Enum.GetName(typeof(BlockType), Value)));
    ...
    {
        Vector3Int pos = Vector3Int.RoundToInt(screenPos);
        foreach(BaseBlock block in selectRBlock.BlockList)
