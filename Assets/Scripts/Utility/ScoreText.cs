...
public class ScoreText : MonoBehaviour
{
    ...
    private static List<List<ContainerBlock>> blockList = new List<List<ContainerBlock>>();
    //int count = 0;
    ...
    public static void UpdateText() //スコアは足していくから逆になる
    {
        // if(FM == null)
        // {
        //     FM = FindFirstObjectByType<NewFrameManager>();
        //     if(!FM) return;
        // }
        ...
        //             Map.text += "＿";
        //             continue;
        //             //if(y < NewFrameManager.ValidFrameArray.GetLength(0) && x < NewFrameManager.ValidFrameArray.GetLength(1) && NewFrameManager.ValidFrameArray[y, x] == 1) Map.text += "■";
        //             //else Map.text += "？";
        //         }
