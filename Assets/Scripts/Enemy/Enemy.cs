...
public class Enemy : MonoBehaviour
{
    ...
    Shield shield;
    List<EBlockColor> weakColorList = new List<EBlockColor>();
    ...
    public async void Damage(AttackController attackRBlock) //ダメージ処理
    {
        ...
        foreach(EBlockColor colorType in weakColorList)
        {
        ...
        _ = this.transform.DOShakePosition(0.5f, 0.7f, 20, 1, false, true);
