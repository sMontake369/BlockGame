...
//     public List<ContainerBlockData> rootBlockDataList;
...
//     {
//         foreach (ContainerBlockData rootBlockData in rootBlockDataList)
//         {
//             ContainerBlock rootBlock = GamM.GenerateRBlock(rootBlockData);
